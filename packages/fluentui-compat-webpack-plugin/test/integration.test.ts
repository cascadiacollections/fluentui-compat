...
describe('FluentUICompatPlugin Integration', () => {
  ...
  it('should work with custom mapping configurations', () => {
    ...
    expect(rewriteRequest('@custom/ui-library/OldComponent')).toBe('@my/compat-library');
    expect(rewriteRequest('@another/package')).toBe('@another/compat-package');
    expect(rewriteRequest('@another/package/submodule')).toBe('@another/compat-package/submodule');
